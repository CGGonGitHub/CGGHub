...
local Toggle = AutocompleteSection:AddToggle("Autocomplete Normal", {flag = "Toggle_Flag", default = false}, function(bool)
    looping = bool
        for count = previousPos, 240, 1 do
            ...
            previousPos = count
            if not looping then game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = workspace.Checkpoints[1].CFrame + Vector3.new(0,3,0) break end
            task.wait(speeds[_G.Autocompletespeed])
        end
end)
local Slider = AutocompleteSection:AddSlider("Speed of the autocomplete", 1, 10, 1, {toggleable = false, default = false, flag = "Slider_Flag", fireontoggle = true, fireondrag = true, rounded = true}, function(val, bool)
...
local OtherSection = MainTab:AddSection("Other stuff", {default = false})
local Button = OtherSection:AddButton("Teleport to Spawn", function()
    game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = workspace.Checkpoints[1].CFrame + Vector3.new(0,3,0)
end)
local Button = OtherSection:AddButton("Get Rainbow Fly Carpet", function()
	local previouspos = game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame
    game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(-529, 3455, -647)
    task.wait()
    game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = previouspos
end)
local Button = OtherSection:AddButton("Teleport to End", function()
	game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(-534, 3455, -630)
end)
local SecretsSection = MainTab:AddSection("Secrets + Badges", {default = false})
local Button = SecretsSection:AddButton("Get Secret Badge1", function()
	game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(-168, 171, 263)
end)
local Button = SecretsSection:AddButton("Get Secret Badge 2", function()
	game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(-25, -179, 3341)
end)
-- Localplayer
